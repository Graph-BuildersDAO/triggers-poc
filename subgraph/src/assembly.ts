...
export namespace contract {
  export namespace v1 {
    export class Transfers {
      public transfers: Array<Transfer> = new Array<Transfer>();

      // Decodes Transfers from an ArrayBuffer
      static decode(buf: ArrayBuffer): Transfers {
        return Transfers.decodeDataView(new DataView(buf));
      }

      // Decodes Transfers from a DataView
      static decodeDataView(view: DataView): Transfers {
        const decoder = new __proto.Decoder(view);
        const obj = new Transfers();
      ...
      public size(): u32 {
        ...
        for (let n: i32 = 0; n < this.transfers.length; n++) {
          const messageSize = this.transfers[n].size();
      ...
      // Encodes Transfers to the ArrayBuffer
      encode(): ArrayBuffer {
        return changetype<ArrayBuffer>(
          StaticArray.fromArray<u8>(this.encodeU8Array())
        );
      ...
      // Encodes Transfers to the Array<u8>
      encodeU8Array(
        encoder: __proto.Encoder = new __proto.Encoder(new Array<u8>())
      ): Array<u8> {
        const buf = encoder.buf;
        ...
        for (let n: i32 = 0; n < this.transfers.length; n++) {
          ...
          if (messageSize > 0) {
            ...
            this.transfers[n].encodeU8Array(encoder);
          }
        }
    ...
    export class Transfer {
      public evt_tx_hash: string = "";
      public evt_index: u32;
      public evt_block_time: google.protobuf.Timestamp =
        new google.protobuf.Timestamp();
      public evt_block_number: u64;
      public from: string = "";
      public to: string = "";
      public value: string = "";
      public from_balance: string = "";
      public to_balance: string = "";
      ...
      static decodeDataView(view: DataView): Transfer {
        ...
        while (!decoder.eof()) {
          ...
          switch (number) {
            case 1: {
              obj.evt_tx_hash = decoder.string();
              break;
            }
            case 2: {
              obj.evt_index = decoder.uint32();
              break;
            }
            case 3: {
              const length = decoder.uint32();
              obj.evt_block_time = google.protobuf.Timestamp.decodeDataView(
                new DataView(
                  decoder.view.buffer,
                  decoder.pos + decoder.view.byteOffset,
                  length
            ...
            case 4: {
              obj.evt_block_number = decoder.uint64();
              break;
            }
            case 5: {
            ...
            case 8: {
              obj.from_balance = decoder.string();
              break;
            }
            case 9: {
              obj.to_balance = decoder.string();
              break;
            }
      ...
      public size(): u32 {
        ...
        size +=
          this.evt_tx_hash.length > 0
            ? 1 +
              __proto.Sizer.varint64(this.evt_tx_hash.length) +
              this.evt_tx_hash.length
            : 0;
        size +=
          this.evt_index == 0 ? 0 : 1 + __proto.Sizer.uint32(this.evt_index);

        if (this.evt_block_time != null) {
          const f: google.protobuf.Timestamp = this
            .evt_block_time as google.protobuf.Timestamp;
        ...
        size +=
          this.evt_block_number == 0
            ? 0
            : 1 + __proto.Sizer.uint64(this.evt_block_number);
        size +=
          this.from.length > 0
        ...
        size +=
          this.value.length > 0
            ...
            : 0;
        size +=
          this.from_balance.length > 0
            ? 1 +
              __proto.Sizer.varint64(this.from_balance.length) +
              this.from_balance.length
            : 0;
        size +=
          this.to_balance.length > 0
            ? 1 +
              __proto.Sizer.varint64(this.to_balance.length) +
              this.to_balance.length
            : 0;
      ...
      encodeU8Array(
        ...
        if (this.evt_tx_hash.length > 0) {
          encoder.uint32(0xa);
          encoder.uint32(this.evt_tx_hash.length);
          encoder.string(this.evt_tx_hash);
        }
        if (this.evt_index != 0) {
          encoder.uint32(0x10);
          encoder.uint32(this.evt_index);
        }

        if (this.evt_block_time != null) {
          const f = this.evt_block_time as google.protobuf.Timestamp;
        ...
        if (this.evt_block_number != 0) {
          encoder.uint32(0x20);
          encoder.uint64(this.evt_block_number);
        }
        ...
        if (this.from_balance.length > 0) {
          encoder.uint32(0x42);
          encoder.uint32(this.from_balance.length);
          encoder.string(this.from_balance);
        }
        if (this.to_balance.length > 0) {
          encoder.uint32(0x4a);
          encoder.uint32(this.to_balance.length);
          encoder.string(this.to_balance);
        }
